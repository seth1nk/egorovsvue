<template>
  <main>
    <div class="container">
      <h1 class="page-title">Ремонт велосипедов</h1>
  ...
  data() {
    return {
      services: [
        {
          name: 'Ремонт колес',
          description: 'Быстрая замена и ремонт шин, настройка спиц и балансировка колес.',
          image: '/images/1.png'
        },
        {
          name: 'Настройка трансмиссии',
          description: 'Точная настройка переключателей и цепи для плавного переключения скоростей.',
          image: '/images/2.png'
        },
        {
          name: 'Общее обслуживание',
          description: 'Комплексная проверка и обслуживание всех систем велосипеда.',
          image: '/images/3.png'
        }
      ],
      reasons: [
        'Широкий спектр услуг для всех типов велосипедов',
        'Использование качественных запчастей и инструментов',
