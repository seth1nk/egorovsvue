<template>
  <main>
    <div class="container">
      <h1 class="page-title">Добро пожаловать в нашу гостиницу</h1>
      ...
      services: [
        {
          ...
          description: 'Удобное бронирование номеров под ваши даты и предпочтения.',
          image: '/images/1.jpg'
        },
        {
          name: 'Обслуживание 24/7',
          description: 'Круглосуточная поддержка гостей для комфортного пребывания.',
          image: '/images/2.jpg'
        },
        {
          name: 'Дополнительные услуги',
          description: 'Экскурсии, трансфер и другие услуги для вашего отдыха.',
          image: '/images/3.jpg'
        }
      ],
      reasons: [
        'Комфортабельные номера всех категорий',
        'Высокий уровень сервиса и гостеприимства',
        'Удобное расположение и круглосуточная поддержка'
      ]
    };
  },
  mounted() {
