<template>
  <main>
    <div class="container">
      <h1 class="page-title">Продажа телевизоров</h1>
...
export default {
  ...
  data() {
    return {
      services: [
        {
          name: 'Подбор телевизора',
          description: 'Помощь в выборе модели телевизора под ваши потребности и бюджет.',
          image: '/images/1.png'
        },
        {
          name: 'Консультации по характеристикам',
          description: 'Подробные консультации по технологиям экрана и функциям телевизоров.',
          image: '/images/2.png'
        },
        {
          name: 'Доставка и установка',
          description: 'Быстрая доставка и профессиональная установка телевизоров у вас дома.',
          image: '/images/3.png'
        }
      ],
      reasons: [
        'Широкий ассортимент телевизоров от ведущих брендов',
        'Гарантия качества и оригинальности продукции',
        'Профессиональная поддержка и быстрая доставка'
      ]
    };
  },
  mounted() {
